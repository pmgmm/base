...
function saveRecord(option) {
    ...
    if ([-1, 0, 1].includes(option)) {
        ...
        var components = ['role_name','role_permissions'];
        ...
        if (FormHelper.validateComponents(components) && specificValidations()) {
            ...
            obj_ajax_helper.call({
                ...
                action_data: {
                    ...
                    name: FormHelper.getComponentValue('role_name'),
                    description: FormHelper.getComponentValue('role_description'),
                    permissions: FormHelper.getComponentValue('role_permissions'),
                    active: !!+FormHelper.getComponentValue('role_active')
                }, 
                before: function() {
                }, 
