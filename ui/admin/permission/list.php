...
final class _list {
    ...
    final public function run(): void {
        try {
            ...
            $obj_page->setSubTitle(TH::translate('Permissões'));
            $obj_page->setCurrentMenu('adm');
            $obj_page->setBreadcrumb(TH::translate('ORGANIZAÇÃO'), true);
            $obj_page->setBreadcrumb(TH::translate('PERMISSÕES'));
            ...
            // Recebe permissões  
            $permissions = PermissionHelper::validateList(array('ADMINISTRATION', 'SUPPORT', 'PERMISSION'));
            ...
            $table_columns = array();
            $table_columns['sp.code'] = array('title' => TH::translate('CÓDIGO'), 'width' => 200, 'order' => true);
            $table_columns['sp.description'] = array('title' => TH::translate('DESCRIÇÃO'), 'width' => 400);
            $table_columns['sp.type'] = array('title' => TH::translate('TIPO'), 'width' => 100,'align' => 'center');
            ...
            $db_filter = array('list' => 'permissions_list', 'user_id' => array($_SESSION['USER']['id'], null), 'active' => true);
            ...
            <!-- Componente table -->
            <fwk-table id="permissions_list" disable="false" color="gray">
                ...
                <div slot="filter-component" style="padding-right: 10px;">
                    ...
                    <fwk-input id="filter_search" type="text" placeholder="> 2 <?=TH::translate('carateres')?>" maxlength="50" tooltip-position="left">
                        <span slot="information"><?=TH::translate('Sobre as colunas:')?><br><?=TH::translate('CÓDIGO')?> <?=TH::translate('e')?> <?=TH::translate('DESCRIÇÃO')?></span>
                    </fwk-input>
                </div>
                ...
                <div slot="filter-component">
                    ...
                    <fwk-select id="permission_type" key-value="value" key-text="description" placeholder="<?=TH::translate('Todos')?>" width="150">
                    <div slot="options">[{"value": "c", "description":"<?=TH::translate('CRUD')?>"},{"value": "f", "description":"<?=TH::translate('Funcional')?>"}, {"value": "m", "description":"<?=TH::translate('Módulo')?>"},{"value": "s", "description":"<?=TH::translate('Sistema')?>"}]</div>
                    </fwk-select>
                </div>
