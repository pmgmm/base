...
final class _list {
    ...
    final public function run(): void {
        try {
            ...
            // Recebe permissões  
            $permissions = PermissionHelper::validateList(array('ADMINISTRATION', 'SUPPORT', 'GROUP'));
            ...
            $table_columns = array();
            $table_columns['sg.name'] = array('title' => TH::translate('NOME'), 'width' => 230, 'order' => true);
            $table_columns['sg.description'] = array('title' => TH::translate('DESCRIÇÃO'), 'width' => 400);
            $table_columns['sg.active'] = array('title' => TH::translate('ATIVO'), 'width' => 60, 'align' => 'center');
            ...
            $db_filter = array('list' => 'groups_list', 'user_id' => array($_SESSION['USER']['id'], null), 'active' => true);
            ...
            <!-- Componente table -->
            <fwk-table id="groups_list" disable="false" color="gray">
                ...
                <div slot="filter-component">
                    ...
                    <fwk-select id="group_active" key-value="value" key-text="name" placeholder="<?=TH::translate('Todos')?>" width="150">
                        <div slot="options">[{"value": 1, "name":"<?=TH::translate('Ativo')?>"},{"value": 0, "name":"<?=TH::translate('Inativo')?>"}]</div>
                    </fwk-select>
                </div>
