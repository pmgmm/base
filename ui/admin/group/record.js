        ...
        if (FormHelper.validateComponents(components) && specificValidations()) {
            ...
            obj_ajax_helper.call({
                ...
                action_data: {
                    ...
                    name: FormHelper.getComponentValue('group_name'),
                    description: FormHelper.getComponentValue('group_description'),
                    active: !!+FormHelper.getComponentValue('group_active')
                }, 
                before: function() {
                }, 
                success: function(content) {
                    ...
                    switch(option) {
                        case -1:
                            ...
                            break;
                        case 0:
                            window.location.href = `${window.location.pathname}?id=${btoa(FormHelper.getComponentValue('id'))}`;
                            break;
                        case 1:
