...
final class _list {
    ...
    public function run(): void {
        try {
            ...
            $obj_page->setSubTitle(TH::translate('Utilizadores'));
            $obj_page->setCurrentMenu('administration');
            $obj_page->setBreadcrumb(TH::translate('ORGANIZAÇÃO'), true);
            $obj_page->setBreadcrumb(TH::translate('UTILIZADORES'));
            ...
            // Recebe permissões  
            $permissions = PermissionHelper::validateList(array('ADMINISTRATION', 'SUPPORT', 'USER'));
            ...
            $table_columns = array();
            $table_columns['su.name'] = array('title' => TH::translate('NOME'), 'width' => 230, 'order' => true);
            $table_columns['su.user'] = array('title' => TH::translate('UTILIZADOR'), 'width' => 140);
            $table_columns['su.email'] = array('title' => TH::translate('EMAIL'), 'width' => 230);
            $table_columns['su.active'] = array('title' => TH::translate('ATIVO'), 'width' => 60,'align' => 'center');
            ...
            $db_filter = array('list' => 'users_list', 'user_id' => array($_SESSION['USER']['id'], null), 'active' => true);
            ...
            <!-- Componente table -->
            <fwk-table id="users_list" disable="false" color="gray">
                ...
                <div slot="filter-component" style="padding-right: 10px;">
                    ...
                    <fwk-input id="filter_search" type="text" placeholder="> 2 <?=TH::translate('carateres')?>" maxlength="50" tooltip-position="left">
                        <span slot="information"><?=TH::translate('Sobre as colunas:')?><br><?=TH::translate('NOME')?>, <?=TH::translate('UTILIZADOR')?> <?=TH::translate('e')?> <?=TH::translate('EMAIL')?></span>
                    </fwk-input>
                </div>
                ...
                <div slot="filter-component">
                    ...
                    <fwk-select id="user_system" key-value="value" key-text="description" placeholder="<?=TH::translate('Todos')?>" width="150">
                        <div slot="options">[{"value": 0, "description":"<?=TH::translate('Comum')?>"},{"value": 1, "description":"<?=TH::translate('Sistema')?>"}]</div>
                    </fwk-select>
                </div>
                ...
                <div slot="filter-component">
                    ...
                    <fwk-select id="user_active" key-value="value" key-text="description" placeholder="<?=TH::translate('Todos')?>" width="150">
