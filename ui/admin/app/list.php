...
final class _list {
    ...
    final public function run(): void {
        try {
            ...
            $obj_page->setSubTitle(TH::translate('APPS / PWAS'));
            $obj_page->setCurrentMenu('administration');
            $obj_page->setBreadcrumb(TH::translate('APPS / PWAS'), true);
            ...
            // Recebe permissões  
            $permissions = PermissionHelper::validateList(array('ADMINISTRATION', 'SUPPORT', 'APP'));
            ...
            $table_columns = array();
            $table_columns['sa.name'] = array('title' => TH::translate('NOME'), 'width' => 230, 'order' => true);
            $table_columns['sa.description'] = array('title' => TH::translate('DESCRIÇÃO'), 'width' => 400);
            $table_columns['sa.active'] = array('title' => TH::translate('ATIVO'), 'width' => 60,'align' => 'center');
            ...
            $db_filter = array('list' => 'apps_list', 'user_id' => array($_SESSION['USER']['id'], null), 'active' => true);
            ...
            <!-- Componente table -->
            <fwk-table id="apps_list" disable="false" color="gray">
                ...
                <div slot="filter-component">
                    ...
                    <fwk-select id="app_active" key-value="value" key-text="description" placeholder="<?=TH::translate('Todos')?>" width="150">
