        ...
        if (FormHelper.validateComponents(components) && specificValidations()) {
            ...
            obj_ajax_helper.call({
                ...
                action_data: {
                    ...
                    name: FormHelper.getComponentValue('app_name'),
                    description: FormHelper.getComponentValue('app_description'),
                    active: !!+FormHelper.getComponentValue('app_active')
                }, 
                before: function() {
                }, 
