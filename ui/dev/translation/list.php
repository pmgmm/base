<?php
/**
 * UI - LISTA DE TRADUÇÕES
 *  
 * @pmonteiro (yyyy-mm-dd))
 */

namespace UI\dev\translation;
...
final class _list {
    ...
    final public function run(): void {
        try {
            ...
            $obj_page->setSubTitle(TH::translate('Traduções'));
            $obj_page->setCurrentMenu('development');
            $obj_page->setBreadcrumb(TH::translate('IDIOMAS'), true);
            $obj_page->setBreadcrumb(TH::translate('TRADUÇÕES'));
            ...
            // Recebe permissões  
            $permissions = PermissionHelper::validateList(array('ADMINISTRATION', 'DEVELOPMENT', 'TRANSLATION'));
            ...
            $table_columns = array();
            $table_columns['st.source'] = array('title' => TH::translate('ORIGEM'), 'width' => 250, 'tooltip' => true, 'order' => true);
            $table_columns['st.layer'] = array('title' => TH::translate('LAYER'), 'width' => 75, 'align' => 'center');
            $table_columns['st.en_US'] = array('title' => TH::translate('en_US'), 'width' => 250, 'tooltip' => true, 'order' => true);
            $table_columns['st.fr_FR'] = array('title' => TH::translate('fr_FR'), 'width' => 250, 'tooltip' => true, 'order' => true);
            $table_columns['st.es_ES'] = array('title' => TH::translate('es_ES'), 'width' => 250, 'tooltip' => true, 'order' => true);
            ...
            $db_filter = array('list' => 'translations_list', 'user_id' => array($_SESSION['USER']['id'], null), 'active' => true);
            ...
            <!-- Componente table -->
            <fwk-table id="translations_list" disable="false" color="gray">
                ...
                <fwk-button slot="table-bulk-action" value="<?=TH::translate('Eliminar Selecionadas')?>" disable="<?=$delete_disable?>" color="blue" function="confirmDeleteBulk">
               ...
               <fwk-button id="filter_save" slot="filter-top-action" value="<?=TH::translate('Gravar')?>" color="blue" function="obj_filter_helper.confirmSave">
                ...
                <div slot="filter-component">
                    ...
                    <fwk-select id="filter_id" key-value="id" key-text="name" placeholder="<?=TH::translate('Selecione')?>" tooltip-position="left" width="250" function="obj_filter_helper.applySaved">
                ...
                <div slot="filter-component" style="padding-right: 10px;">
                    ...
                    <fwk-input id="filter_search" type="text" placeholder="> 2 <?=TH::translate('carateres')?>" maxlength="50" width="250" tooltip-position="left">
                        <span slot="information"><?=TH::translate('Sobre as colunas:')?><br><?=TH::translate('ORIGEM')?>, en_US, fr_FR <?=TH::translate('e')?> es_ES</span>
                    </fwk-input>
                </div>

                 <!-- Layer -->
                <div slot="filter-component">
                    <fwk-label value="<?=TH::translate('Layer')?>:"></fwk-label>
                    <fwk-select id="filter_layer" key-value="value" key-text="description" placeholder="<?=TH::translate('Todos')?>" width="150">
