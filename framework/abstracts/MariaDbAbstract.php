<?php
/**
 * FRAMEWORK - ABSTRACT - WRAPPER SOBRE MARIADB
 * 
 * Disponibiliza métodos que permitem responder a solicitações sobre sobre a DB MARIADB
...
abstract class MariaDbAbstract {
    ...
    private function connect(): bool {
        try {
            ...
            $this->connection = new \PDO ("mysql:host=$host;port=$port;dbname=$name;charset=utf8", $user, $password,);
    ...
    final public function delete(array $base_table, string $conditions, ?array $parameters=null): int {
        try {
            ...
            // Concatenar statement
            $statement = "DELETE FROM $table_alias USING $table AS $table_alias\nWHERE $conditions";
     ...
     * @pmonteiro (2019-11-20)   
     */
    private function bindParameters(\PDOStatement $statement, ?array $parameters = null): \PDOStatement {
        try {
