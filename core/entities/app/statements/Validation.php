<?php
/**
 * ENTITIES - APP - STATEMENT - VALIDATION
 * 
 * Disponibiliza métodos = statements que gerem validações da entidade APP / PWA
 *  
 * @pmonteiro (yyyy-mm-dd)
 */

namespace CORE\entities\app\statements;
...
class Validation implements \FWK\interfaces\StatementInterface {
    ...
    private function uniqueName(): string {
        try {
            ...
            $statement = 'SELECT id FROM sys_apps WHERE (name = :name) AND id != :id LIMIT 1';
